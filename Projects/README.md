...
|         | Draw UML diagram including descriptions                     | diagram illustrating the solution's classes, objects, and methods, as well as a brief explanation                            | Design       | 1.5 hours     |                 | B         |
|         | Produce Flow diagrams including descriptions                | flowcharts and a brief explanation for each section of the solution to obtain a clearer understanding of the code's proccess | Design       | 3 hours       |                 | B         |
|         | Code start screen                                           | have an inviting screen for client to use                                                                                    | Development  | 2 hours       |                 | C         |
|         | Code login and registration system                          | A working login and register screen with Python and KivyMD with a GUI                                                        | Development  | 3 hours       |                 | C         |
|         | Create show password function                               | make the application more simple for use                                                                                     | Development  | 30 minutes    |                 | C         |
|         | Create welcome screen according to the wireframe diagram    |                                                                                                                              |              |               |                 |           |
